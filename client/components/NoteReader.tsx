...
export default function NoteReader({ note, isOpen, onClose }: NoteReaderProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 overflow-y-auto">
      <div className={`min-h-screen ${isDarkReading ? "bg-slate-900" : "bg-white"}`}>
        {/* Header */}
        <div
              ...
              <div className="flex-1">
                ...
                <div
                  className={`flex flex-wrap items-center gap-3 text-sm ${
                    isDarkReading ? "text-slate-300" : "text-muted-foreground"
                  }`}
                >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            <div>
              <p className={`text-sm ${isDarkReading ? "text-slate-400" : "text-muted-foreground"}`}>
                Downloads
              </p>
          ...
          {/* Note Content */}
          <article
            className={`prose ${isDarkReading ? "prose-invert" : ""} max-w-none mb-12`}
          ...
          {/* Tags */}
          <div className="mb-8">
            <p className={`font-semibold mb-3 ${isDarkReading ? "text-slate-300" : "text-foreground"}`}>
              Topics:
            </p>
          ...
          <div
            className={`border-t border-b ${
              isDarkReading ? "border-slate-700 py-6" : "border-border py-6"
            }`}
          >
          ...
          {/* Author Info */}
          <div className={`mt-8 p-6 rounded-lg ${isDarkReading ? "bg-slate-800" : "bg-card border border-border"}`}>
            <h3 className={`font-bold mb-2 ${isDarkReading ? "text-white" : "text-foreground"}`}>
              About the Author
            </h3>
            <p className={isDarkReading ? "text-slate-300" : "text-muted-foreground"}>
